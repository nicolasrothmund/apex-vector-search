...
,p_default_id_offset=>31085802250216493069
...
wwv_flow_imp_shared.create_user_interface(
 p_id=>wwv_flow_imp.id(31085802250216311605)
,p_theme_id=>42
...
wwv_imp_workspace.create_credential(
 p_id=>wwv_flow_imp.id(24343826101170306763)
...
begin
wwv_imp_workspace.create_credential(
 p_id=>wwv_flow_imp.id(24343825523346281841)
...
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(24343825862927306758)
...
,p_credential_id=>wwv_flow_imp.id(24343826101170306763)
...
begin
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(24343825284312281841)
...
,p_credential_id=>wwv_flow_imp.id(24343825523346281841)
...
begin
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(24342797226954305491)
...
begin
wwv_imp_workspace.create_remote_server(
 p_id=>wwv_flow_imp.id(24342423516640231565)
...
,p_name=>'OCI'
,p_static_id=>'oci'
,p_remote_server_id=>wwv_flow_imp.id(24343825862927306758)
...
,p_name=>'OPENAI'
,p_static_id=>'openai'
,p_remote_server_id=>wwv_flow_imp.id(24343825284312281841)
...
,p_vector_provider_id =>wwv_flow_imp.id(24342423516640231565)
...
,p_query_where=>'SUBSTR(moviedescription, 1, 40) <> SUBSTR(:P41_SEARCH, 1, 40)'
,p_oratext_index_column_name=>'EMBEDDING_VECTOR'
,p_vector_provider_id =>wwv_flow_imp.id(24342797226954305491)
,p_vector_search_type=>'EXACT'
,p_vector_distance_metric=>'DOT'
,p_return_max_results=>5
,p_pk_column_name=>'ID'
